            ...
            <Route
              ...
              render={(props) => (
                <Page
                  {...props}
                  title={i18n.t(
                    ROUTES.ANALYSIS[PATHS.ANALYSIS.TOP_ANAT].i18nKey
                  )}
            ...
            <Route
              ...
              render={(props) => (
                <Page
                  {...props}
                  title={i18n.t(
                    ROUTES.DOWNLOAD[PATHS.DOWNLOAD.DATA_DUMPS].i18nKey
                  )}
                  Component={
                    ROUTES.DOWNLOAD[PATHS.DOWNLOAD.DATA_DUMPS].component
                  }
                />
              )}
            />
            ...
            <Route
              ...
              render={(props) => (
                <Page
                  ...
                  Component={
                    ROUTES.RESOURCES[PATHS.RESOURCES.R_PACKAGES].component
                  }
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <Page
                  {...props}
                  title={i18n.t(
                    ROUTES.RESOURCES[PATHS.RESOURCES.SPARQL].i18nKey
                  )}
            ...
            <Route
              ...
              render={(props) => (
                <Page
                  ...
                  Component={
                    ROUTES.RESOURCES[PATHS.RESOURCES.ONTOLOGIES].component
                  }
                />
              )}
            />
            ...
            <Route
              ...
              render={(props) => (
                <Page
                  {...props}
                  title={i18n.t(
                    ROUTES.ABOUT[PATHS.ABOUT.COLLABORATIONS].i18nKey
                  )}
            ...
            <Route
              ...
              render={(props) => (
                <Page
                  {...props}
                  title={i18n.t(
                    ROUTES.ABOUT[PATHS.ABOUT.PRIVACY_POLICY].i18nKey
                  )}
