    ...
    content: [
      {
        type: 'text',
        content:
          'In addition to the continuous growth of transcriptomics datasets, some specific projects produce large amounts of data, generated and accessible in a consistent manner, as, notably, the ',
      },
      {
        type: 'link_external',
        path: 'https://www.gtexportal.org/home/',
        text: 'GTEx project',
      },
      {
        type: 'text',
    ...
    children: [
      {
        ...
        content: [
          ...
          {
            type: 'text',
            content: ' (with sensitive information hidden).',
          },
        ],
      },
      {
        type: 'bold',
        content: 'GTEx data into our website.',
      },
      {
        type: 'unordered_list',
        children: [
          {
            ...
            content: [
              {
                type: 'text',
                content: 'Annotations can be retrieved from ',
              },
              {
                type: 'link_external',
                path: 'ftp://ftp.bgee.org/current//download/processed_expr_values/rna_seq/Homo_sapiens/Homo_sapiens_RNA-Seq_experiments_libraries.tar.gz',
                text: 'RNA-Seq human experiments/libraries info',
              },
              {
                type: 'text',
                content: ". Experiment ID of GTEx is 'SRP012682'.",
              },
            ],
          },
          {
            ...
            content: [
              {
                type: 'text',
                content:
                  'Processed expression values, from GTEx only, are available on our FTP (',
              },
              {
                type: 'link_external',
                path: 'ftp://ftp.bgee.org/current//download/processed_expr_values/rna_seq/Homo_sapiens/Homo_sapiens_RNA-Seq_read_counts_TPM_FPKM_SRP012682.tsv.tar.gz',
                text: 'download file',
              },
              {
                type: 'text',
          ...
          },
          {
            ...
            content: [
              {
                type: 'text',
                content: 'Gene expression calls are included into ',
              },
              {
                type: 'link_internal',
                path: `${PATHS.DOWNLOAD.GENE_EXPRESSION_CALLS}?type=single&id=0`,
                text: 'human files',
              },
            ],
          },
            ...
            content: [
              {
                type: 'text',
                content:
                  ' Each human gene page includes GTEx data if there is any (search a gene ',
              },
              {
                type: 'link_internal',
          ...
          },
          {
            ...
            content: [
              {
                type: 'text',
                content: 'TopAnat analyses can be performs ',
              },
              {
                type: 'link_internal',
              ...
              },
              {
                type: 'text',
                content:
                  ', which leverage the power of the abundant GTEx data integrated with many smaller datasets to provide biological insight into gene lists.',
              },
            ],
          },
        ],
      ...
      {
        type: 'bold',
        content: 'GTEx data using BgeeDB R package',
      },
      {
        type: 'rich_text',
        content: [
          {
            type: 'text',
            content: 'More information and examples can be found on the ',
          },
          {
            type: 'link_external',
            path: 'https://bioconductor.org/packages/release/bioc/html/BgeeDB.html',
            text: 'Bgee R package page',
          },
          {
            type: 'text',
            content: '.',
        ...
        children: [
          {
            ...
            content: [
              ...
              {
                type: 'pre_code',
                content: `    if (!requireNamespace("BiocManager", quietly = TRUE))
    ...
    myAnnotation <- getAnnotation(bgee)`,
          ...
          },
          {
            ...
            content: [
              ...
              {
                type: 'pre_code',
                content: `    bgee <- Bgee$new(species = "Homo_sapiens", dataType = "rna_seq")
    ...
    dataGTEx <- getData(bgee, experimentId = "SRP012682")`,
          ...
          },
          {
            ...
            content: [
              ...
              {
                type: 'pre_code',
                content: `    bgee <- Bgee$new(species = "Homo_sapiens")
