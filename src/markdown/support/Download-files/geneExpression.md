...
* __single-cell RNA-Seq data__: as of Bgee 15.0, only full-length protocols are integrated. The method used is the same as for bulk RNA-Seq data for each cell/library.
