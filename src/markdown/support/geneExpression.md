...
This documentation describes the format of presence/absence expression calls download files, and how values of each column are generated. The files can be found in the Bgee [download page](/download/gene-expression-calls "Bgee expression data page") for each species.
