...
|---|---|:---:|
|1|[Experiment ID](#lib_col1 "See Experiment ID column description")|ERP013381|
|2|[Library ID](#lib_col2 "See Library ID column description")|ERX1226594|
|3|[Anatomical entity ID](#lib_col3 "See Anatomical entity ID column description")|UBERON:0000922|
|4|[Anatomical entity name](#lib_col4 "See Anatomical entity name column description")|embryo|
|5|[Stage ID](#lib_col5 "See Stage ID column description")|MmusDv:0000014|
|6|[Stage name](#lib_col6 "See Stage name column description")|Theiler stage 09 (mouse)|
|7|[Cell type ID](#lib_col7 "See Cell type ID column description")|CL:0000352|
|8|[Cell type name](#lib_col8 "See Cell type name column description")|epiblast cell|
|9|[Sex](#lib_col9 "See Sex column description")|NA|
|10|[Strain](#lib_col10 "See Strain column description")|CD-1|
|11|[Expression mapped anatomical entity ID](#lib_col11 "See Expression mapped anatomical entity ID column description")|UBERON:0000922|
|12|[Expression mapped anatomical entity name](#lib_col12 "See Expression mapped anatomical entity name column description")|embryo|
|13|[Expression mapped stage ID](#lib_col13 "See Expression mapped stage ID column description")|MmusDv:0000014|
|14|[Expression mapped stage name](#lib_col14 "See Expression mapped stage name column description")|Theiler stage 09 (mouse)|
|15|[Expression mapped cell type ID](#lib_col15 "See Expression mapped cell type ID column description")|CL:0000352|
|16|[Expression mapped cell type name](#lib_col16 "See Expression mapped cell type name column description")|epiblast cell|
|17|[Expression mapped sex](#lib_col17 "See Expression mapped sex column description")|not annotated|
|18|[Expression mapped strain](#lib_col18 "See Expression mapped strain column description")|CD-1|
|19|[Platform ID](#lib_col19 "See Platform ID column description")|Illumina HiSeq 2500|
|20|[Library type](#lib_col20 "See Library type column description")|single|
|21|[Library orientation](#lib_col21 "See Library orientation column description")|NA|
|22|[TPM expression threshold](#lib_col22 "See TPM expression threshold column description")|3.88442|
|23|[Read count](#lib_col23 "See Read count column description")|3238518|
|24|[Mapped read count](#lib_col24 "See Mapped read count column description")|1467281|
|25|[Min. read length](#lib_col25 "See Min. read length column description")|125|
|26|[Max. read length](#lib_col26 "See Max. read length column description")|125|
|27|[All genes percent present](#lib_col27 "See All genes percent present column description")|13.79|
|28|[Protein coding genes percent present](#lib_col28 "See Protein coding genes percent present column description")|31.54|
|29|[Intergenic regions percent present](#lib_col29 "See Intergenic regions percent present column description")|1.55|
|30|[Distinct rank count](#lib_col30 "See Distinct rank count column description")|10642|
|31|[Max rank in the expression mapped condition](#lib_col31 "See Max rank in the expression mapped condition column description")|NA|
|32|[Run IDs](#lib_col32 "See Run IDs column description")|NA|
|33|[Data source](#lib_col33 "See Data source column description")|SRA|
|34|[Data source URL](#lib_col34 "See Data source URL column description")|https://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?cmd=viewer&m=data&s=viewer&run=ERX1226594|
|35|[Bgee normalized data URL](#lib_col35 "See Bgee normalized data URL column description")|ftp://ftp.bgee.org/bgee_v15_0/download/processed_expr_values/full_length_sc_rna_seq/Mus_musculus/Mus_musculus_Full-Length_SC_RNA-Seq_read_counts_TPM_FPKM_ERP013381.tsv.tar.gz|
|36|[Raw file URL](#lib_col36 "See Raw file URL column description")|https://trace.ncbi.nlm.nih.gov/Traces/study/?acc=ERX1226594|
...
##### <a name="lib_col12"></a>Expression mapped anatomical entity name (column 12)
...
##### <a name="lib_col13"></a>Expression mapped stage ID (column 13)
...
##### <a name="lib_col14"></a>Expression mapped stage name (column 14)
...
##### <a name="lib_col15"></a>Expression mapped cell type ID (column 15)
...
##### <a name="lib_col16"></a>Expression mapped cell type name (column 16)
...
##### <a name="lib_col17"></a>Expression mapped sex (column 17)
The Expression mapped sex column provides the sexes information used in the Bgee expression calls.

##### <a name="lib_col18"></a>Expression mapped strain (column 18)
...
##### <a name="lib_col28"></a>Protein coding genes percent present (column 28)
...
##### <a name="lib_col29"></a>Intergenic regions percent present (column 29)
...
##### <a name="lib_col30"></a>Distinct rank count (column 30)
...
##### <a name="lib_col31"></a>Max rank in the expression mapped condition (column 31)
...
##### <a name="lib_col32"></a>Run IDs (column 32)
The Run IDs column refers to a sequencing run associated to `library ID` (column 2).

##### <a name="lib_col33"></a>Data source (column 33)
Data repository from where the raw files were extracted. Collect all `Run IDs` (column 32) correspondent to the a target `library ID` (column 2).

##### <a name="lib_col34"></a>Data source URL (column 34)
URL pathway to the data repository where is located the `library ID` (column 2).

##### <a name="lib_col35"></a>Bgee normalized data URL (column 35)
URL pathway where is located the processed data for the correspondent `Experiment ID` (column 1) in Bgee.

##### <a name="lib_col36"></a>Raw file URL (column 36)
URL pathway to the SRA Run Selector. This allow to access to the `Run IDs` (column 32) through the `library ID` (column 2).
...
|Column|Content|Example|
|---|---|:---:|
|1|[Experiment ID](#exp_col1 "See Experiment ID column description")|ERP013381|
|2|[Experiment name](#exp_col2 "See Experiment name column description")|Mouse embryonic RNA-seq|
|3|[Library count](#exp_col3 "See Library count column description")|1205|
|4|[Condition count](#exp_col4 "See Condition count column description")|4|
|5|[Organ-stage count](#exp_col5 "See Organ-stage count column description")|4|
|6|[Organ count](#exp_col6 "See Organ count column description")|1|
|7|[Stage count](#exp_col7 "See Stage count column description")|4|
|8|[Cell-Type count](#exp_col8 "See Cell-Type count column description")|2|
|9|[Sex count](#exp_col9 "See Sex count column description")|1|
|10|[Strain count](#exp_col10 "See Strain count column description")|1|
|11|[Data source](#exp_col11 "See Data source column description")|SRA|
|12|[Data source URL](#exp_col12 "See Data source URL column description")|https://www.ncbi.nlm.nih.gov/sra/ERP013381|
|13|[Bgee normalized data URL](#exp_col13 "See Bgee normalized data URL column description")|ftp://ftp.bgee.org/bgee_v15_0/download/processed_expr_values/full_length_sc_rna_seq/Mus_musculus/Mus_musculus_Full-Length_SC_RNA-Seq_read_counts_TPM_FPKM_ERP013381.tsv.tar.gz|
|14|[Experiment description](#exp_col14 "See Experiment description column description")|The study was aimed at interrogating the early stages of blood cell development within the embryo...|
...
|Column|Content|Example|
|---|---|:---:|
|1|[Experiment ID](#procVal_col1 "See Experiment ID column description")|SRP020490|
|2|[Library ID](#procVal_col2 "See Library ID column description")|SRX259105|
|3|[Library type](#procVal_col3 "See Library type column description")|single|
|4|[Gene ID](#procVal_col4 "See Gene ID column description")|ENSMUSG00000000001|
|5|[Anatomical entity ID](#procVal_col5 "See Anatomical entity ID column description")|UBERON:0000085|
|6|[Anatomical entity name](#procVal_col6 "See Anatomical entity name column description")|morula|
|7|[Stage ID](#procVal_col7 "See Stage ID column description")|MmusDv:0000006|
|8|[Stage name](#procVal_col8 "See Stage name column description")|Theiler stage 03 (mouse)|
|9|[Cell type ID](#procVal_col9 "See Cell type ID column description")|CL:0000353|
|10|[Cell type name](#procVal_col10 "See Cell type name column description")|blastoderm cell|
|11|[Sex](#procVal_col11 "See Sex column description")|NA|
|12|[Strain](#procVal_col12 "See Strain column description")|CAST_EiJ(mother)_x_C57BL_6J(father)|
|13|[Read count](#procVal_col13 "See Read count column description")|2154|
|14|[TPM](#procVal_col14 "See TPM column description")|54.538026|
|15|[FPKM](#procVal_col15 "See FPKM column description")|55.33224|
|16|[Rank](#procVal_col16 "See Rank column description")|2465|
|17|[Detection flag](#procVal_col17 "See Detection flag column description")|present|
|18|[pValue](#procVal_col18 "See pValue column description")|3.70353E-06|
|19|[State in Bgee](#procVal_col19 "See State in Bgee column description")|Part of a call|
...
##### <a name="procVal_col9"></a>Cell type ID (column 9)
The Cell type ID column provides the unique identifier of the cell type, from the Uberon ontology.

##### <a name="procVal_col10"></a>Cell type name (column 10)
The Cell type name column provides the name of the cell type defined by `Cell type ID` (column 9).

##### <a name="procVal_col11"></a>Sex (column 11)
The Sex column provides the sexes information.
...
##### <a name="procVal_col18"></a>pValue (column 18)
