...
const Home = () => (
  <>
    <div className="hero" style={{ backgroundColor: '#d9d9d9' }}>
      ...
      <div className="columns">
        <div className="column is-4">
          <div>
            ...
            patterns across multiple animal species, produced from multiple data
            types (bulk RNA-Seq, single-cell RNA-Seq, Affymetrix, in situ
            hybridization, and EST data) and from multiple data sets (including{' '}
            <a
        ...
        <div className="column is-4">
          <div>
            ...
            information of gene orthology, and of homology between organs. This
            allows comparisons of expression patterns between species.
          </div>
        </div>
      </div>
